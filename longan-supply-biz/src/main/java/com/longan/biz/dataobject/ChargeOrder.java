...
public class ChargeOrder {
	...
	return Constants.ChargeOrder.STATUS_INIT == status;
    }
	...
	return Constants.ChargeOrder.STATUS_UNCONFIRMED == status || Constants.ChargeOrder.STATUS_INIT == status;
    }
	...
	return Constants.ChargeOrder.STATUS_SUCCESS == status;
    }
	...
	if (Constants.ChargeOrder.STATUS_INIT == status) {
	    result = Constants.ChargeOrder.STATUS_INIT_DESC;
	} else if (Constants.ChargeOrder.STATUS_SUCCESS == status) {
	    result = Constants.ChargeOrder.STATUS_SUCCESS_DESC;
	} else if (Constants.ChargeOrder.STATUS_FAILED == status) {
	    result = Constants.ChargeOrder.STATUS_FAILED_DESC;
	} else if (Constants.ChargeOrder.STATUS_UNCONFIRMED == status) {
	    result = Constants.ChargeOrder.STATUS_UNCONFIRMED_DESC;
	}
	return result;
    }
}